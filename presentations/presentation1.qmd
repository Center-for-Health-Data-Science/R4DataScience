...
1.  If a variable has more than \~20% missing data, it probably won’t be useful. Let’s remove those:
...
```{r results="show"}
df_ov <- df_ov %>% 
  mutate(dominant_cell_type = ifelse(percent_not_cancer_cells > percent_tumor_cells, 
                                     "not_cancer_cells", 
                                     "cancer_cells"))
