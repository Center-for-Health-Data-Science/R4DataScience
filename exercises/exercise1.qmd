...
10. Join the cleaned versions of the clinical and meta dataset by the variable and with the function you considered above.
...
12. To avoid potential issues in downstream analysis, change the `Work` variable so that `Self-employed` becomes `SelfEmployed`. N.B use a regular expression for this operation!
