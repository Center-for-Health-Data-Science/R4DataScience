...
20. Before running K-means clustering please remove any missing values across all variables in your dataset. Consider which columns you can use and if you have to do anything to them before clustering?

21. Run the k-means clustering algorithm with 4 centers on the data. Look at the plot you have generated.
