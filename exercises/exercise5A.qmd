---
title: "Exercise 5A: Linear and Logistic Regression"
format: html
project:
 type: website
 output-dir: ../docs
...
In this exercise you will fit and interpret simple regression models.
...
N.B if you did not manage to finish making this dataset or forgot to save it, you can find a copy here: `data/exercise1_diabetes_join.xlsx`. 
...
12. Read in the joined diabetes dataset.
